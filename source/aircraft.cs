...
public static Offset<byte> ENG_annunALTN = new Offset<byte>("pmdg", 0x6436);
        ...
        public static Offset<byte> FUEL_PumpFwdLeftSw = new Offset<byte>("pmdg", 0x645D);   
        public static Offset<byte> FUEL_PumpFwdRightSw = new Offset<byte>("pmdg", 0x645E);   
        public static Offset<byte> FUEL_PumpAftLeftSw = new Offset<byte>("pmdg", 0x645F);
        public static Offset<byte> FUEL_PumpAftRightSw = new Offset<byte>("pmdg", 0x6460);
        public static Offset<byte> FUEL_PumpCtrLeftSw = new Offset<byte>("pmdg", 0x6461);
        public static Offset<byte> FUEL_PumpCtrRightSw = new Offset<byte>("pmdg", 0x6462);
        public static Offset<byte> FUEL_annunENG1_VALVE_CLOSED = new Offset<byte>("pmdg", 0x6463);
        public static Offset<byte> FUEL_annunENG2_VALVE_CLOSED = new Offset<byte>("pmdg", 0x6464);
        public static Offset<byte> FUEL_annunSPAR1_VALVE_CLOSED = new Offset<byte>("pmdg", 0x6465);
        public static Offset<byte> FUEL_annunSPAR2_VALVE_CLOSED = new Offset<byte>("pmdg", 0x6466);
        ...
        public static Offset<byte> FUEL_annunLOWPRESS_LeftFwd = new Offset<byte>("pmdg", 0x646A);
        public static Offset<byte> FUEL_annunLOWPRESS_RightFwd = new Offset<byte>("pmdg", 0x646B);
        public static Offset<byte> FUEL_annunLOWPRESS_LeftAft = new Offset<byte>("pmdg", 0x646C);
        public static Offset<byte> FUEL_annunLOWPRESS_RightAft = new Offset<byte>("pmdg", 0x646D);
        public static Offset<byte> FUEL_annunLOWPRESS_LeftCtr = new Offset<byte>("pmdg", 0x646E);
        public static Offset<byte> FUEL_annunLOWPRESS_RightCtr = new Offset<byte>("pmdg", 0x646F);
        // ELECTRICAL
        ...
        public static Offset<byte> HYD_PumpSw_eng1 = new Offset<byte>("pmdg", 0x64C7);
        public static Offset<byte> HYD_PumpSw_eng2 = new Offset<byte>("pmdg", 0x64C8);
        public static Offset<byte> HYD_PumpSw_elec2 = new Offset<byte>("pmdg", 0x64C9);
        public static Offset<byte> HYD_PumpSw_elec1 = new Offset<byte>("pmdg", 0x64CA);
        // AIR SYSTEMS
        ...
        public static Offset<byte> AIR_RecircFanSwitchLeft = new Offset<byte>("pmdg", 0x64D3);
        public static Offset<byte> AIR_RecircFanSwitchRight = new Offset<byte>("pmdg", 0x64D4);
        public static Offset<byte> AIR_PackSwitchLeft = new Offset<byte>("pmdg", 0x64D5);
        public static Offset<byte> AIR_PackSwitchRight = new Offset<byte>("pmdg", 0x64D6);
        public static Offset<byte> AIR_BleedAirSwitchLeft = new Offset<byte>("pmdg", 0x64D7);
        public static Offset<byte> AIR_BleedAirSwitchRight = new Offset<byte>("pmdg", 0x64D8);
        ...
        public static Offset<ushort> MCP_Altitude = new Offset<ushort>("pmdg", 0x652E);
